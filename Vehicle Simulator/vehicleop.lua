...
--Properties:
VehicleSimulatorGUI.Name = "Vehicle Simulator GUI"
VehicleSimulatorGUI.Parent = game.CoreGui
VehicleSimulatorGUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

OpenFrame.Name = "OpenFrame"
OpenFrame.Parent = VehicleSimulatorGUI
...
Main.Name = "Main"
Main.Parent = VehicleSimulatorGUI
Main.Active = true
