local Config = {
    WindowName = "Vehicle Simulator GUI",
...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Steven55704/idklmaoxd/main/Vehicle%20Simulator/gui.lua"))()
...
Section3:CreateLabel("Credits Steven55704")
